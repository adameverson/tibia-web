    ...
    <head>
     ...
     crossorigin="anonymous"></script>
        ...
        <script>
            ...
            function code(){
                document.getElementById("cartaoId").innerHTML = 'Code Web:<br><br><a href="https://github.com/adameverson/tibia-web">Magic Level v1.27.114</a><br><br>Code Android:<br><br><a href="https://github.com/adameverson/tibia-general">Magic Level v0.2.8</a>';
            }
...
<div id="cartaoId" class="cartao" title="game" alt="game">
    ...
    <br>- «silêncio!»
        <img id="cartaoDeVisita" src="imagens/imagemCartaoDeVisita13.png" title="game" alt="game" class="center">
    Novidades:
...
<div style="text-align: center; font-family: 'Lucida Console', 'Courier New', monospace;">
    ©2021-2022 magiclevel.ml. All rights reserved. v1.27.114
</div>