    ...
    <head>
     ...
     crossorigin="anonymous"></script>
        ...
        <script>
            ...
            function monsters(){
                document.getElementById("cartaoId").innerHTML = '-- Monsters --<br><br>- Snake<br><br><img id="snake" src="imagens/Snake.png" title="game" alt="game" class=""><br><br>XP: 1<br>Vida: 51<br>Ataque: 1~50<br><br>- Dragon<br><br><img id="dragon" src="imagens/Dragon.png" title="game" alt="game" class=""><br><br>XP: 2<br>Vida: 101<br>Ataque: 50~150<br><br>- Mammoth<br><br><img id="mammoth" src="imagens/Mammoth.png" title="game" alt="game" class=""><br><br>XP: 3<br>Vida: 201<br>Ataque: 150~450<br><br>- Spider<br><br><img id="spider" src="imagens/Spider.png" title="game" alt="game" class=""><br><br>XP: 4<br>Vida: 401<br>Ataque: 450~1350<br><br><br>-- Bosses --<br><br>- Orc Shaman<br><br><img id="orcshaman" src="imagens/OrcShaman.png" title="game" alt="game" class=""><br><br>XP: 100<br>Vida: 5000<br>Ataque: 1350~4050';
            }
            function spells(){
...
<div id="cartaoId" class="cartao" title="game" alt="game">
    ...
    <br>- «silêncio!»
        <img id="cartaoDeVisita" src="imagens/imagemCartaoDeVisita14.png" title="game" alt="game" class="center">
    Novidades:
