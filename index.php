<html>
    <head>
        ...
        <script>
            ...
            function code(){
                document.getElementById("cartaoId").innerHTML = 'Code Web:<br><br><a href="https://github.com/adameverson/tibia-web">Magic Level v1.21.98</a><br><br>Code Android:<br><br><a href="https://github.com/adameverson/tibia-general">Magic Level v0.2.8</a>';
            }
        </script>
    </head>
...
<div style="text-align: center; font-family: 'Lucida Console', 'Courier New', monospace;">
    ©2021-2022 magiclevel.ml. All rights reserved. v1.21.98
</div>